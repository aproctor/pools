...
class PoolsControllerTest < ActionController::TestCase
  ...
  test "should create pool" do
    assert_difference('Pool.count') do
      post :create, pool: { end_time: @pool.end_time, league_id: @pool.league_id, name: @pool.name, start_time: @pool.start_time }
    end
  ...
  test "should update pool" do
    patch :update, id: @pool, pool: { end_time: @pool.end_time, league_id: @pool.league_id, name: @pool.name, start_time: @pool.start_time }
    assert_redirected_to pool_path(assigns(:pool))
  end
