...
class PicksControllerTest < ActionController::TestCase
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post :create, pick: { match_id: @pick.match_id, player_id: @pick.player_id, pool_id: @pick.pool_id, winner: @pick.winner }
    end
  ...
  test "should update pick" do
    patch :update, id: @pick, pick: { match_id: @pick.match_id, player_id: @pick.player_id, pool_id: @pick.pool_id, winner: @pick.winner }
    assert_redirected_to pick_path(assigns(:pick))
  end
